...
const navigation = [
  {
    name: "Farcaster",
    href: "https://warpcast.com/carehippos",
  ...
  {
    name: "X",
    href: "https://twitter.com/carehippos",
    icon: (props: JSX.IntrinsicAttributes & SVGProps<SVGSVGElement>) => (
...
export default function Footer({
  ...
  return (
    <footer className="w-full bg-background">
      <div className="mx-auto max-w-7xl px-4 py-2 md:py-4 lg:pb-6 md:flex md:items-center md:justify-between md:px-6 lg:px-8">
